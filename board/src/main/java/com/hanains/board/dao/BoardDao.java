...
public class BoardDao {
	...
	// Get Board_INFO_LIKE_WORK Count
		...
		public int getBoardCount(Long div) {

			int count = sqlSession.selectOne("board.getBoardCount", div);		
			return count;
		}
		...
		public List<BoardInfo> getListByFaging(int pagingCount,
				int displayArticleCount, String word, Long div) {
		...
		public List<BoardInfo> getListByFaging(int pagingCount,
				int displayArticleCount, Long div) {
